...
import { DONATION_DETAILS, MARKET_ADD, MARKET_DETAILS } from '../utils/constants';
...
const Market = () => {
  ...
  return (
        ...
        <div className="col-lg-12 col-md-6 col-sm-12">
            <div className="card">
                <div className="card-header pb-0">
                    <h6>Markets</h6>
                    <div className="">
                        <button className="btn btn-sm bg-gradient-info mx-3 " data-bs-toggle="modal" data-bs-target="#new" onClick={ () => addNewMarket() }>Add New Market</button>
    ...
    <div className="row">
    <Modal id={"new"} title={"New Market Post"} >
                    <Formik
                        initialValues={{
                          token: "",
                          name: "",
