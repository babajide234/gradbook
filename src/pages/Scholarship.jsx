...
import { DONATION_DETAILS, SCHOLARSHIP_ADD } from '../utils/constants';
...
const Scholarship = () => {
  ...
  const getscholarships =()=>{
      ...
      .then((result) => {
          setScholarships(result.payload.data.data);
      })
      .catch((err)=>{
        console.log(err);
      })
  ...
  return (
        ...
        <div className="col-lg-12 col-md-6 col-sm-12">
            <div className="card">
                <div className="card-header pb-0">
                    <h6>Scholarships</h6>
                    <div className="">
                        <button className="btn btn-sm bg-gradient-info mx-3 " data-bs-toggle="modal" data-bs-target="#new" onClick={ () => addNewscholarships() }>Add New scholarships</button>
    ...
    <div className="row">
    <Modal id={"new"} title={"New Scholarship Post"} >
                    <Formik
                        initialValues={{
                          token: "",
                          name: "",
